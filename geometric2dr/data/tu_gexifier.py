...
parser.add_argument(
    "-d", "--dataset", help="Path of the directory containing the dataset in TU format"
)
...
graph_indicator_fname = (
    "dortmund_data/" + dataset + "/" + dataset + "_graph_indicator.txt"
)
