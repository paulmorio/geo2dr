...
class InMemoryCorpus(Dataset):
	...
	def pre_load_corpus(self):
		...
		"""
		print("Loading entire dataset, hope you've got enough RAM")
		# Get a single item of data from the dataset.
...
if __name__ == '__main__':
	...
	mem_dataloader = DataLoader(corpus, batch_size=4, shuffle=False, num_workers=0, collate_fn=corpus.collate)