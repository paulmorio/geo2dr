"""
An example of Random Walks MLE Kernel
...
from geometric2dr.decomposition.random_walk_patterns import rw_corpus
...
corpus, vocabulary, prob_map, num_graphs, graph_map = rw_corpus(corpus_data_dir, walk_length=8, neighborhood_size=8, saving_graph_docs=True) # will produce .spp files
